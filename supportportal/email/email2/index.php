...
<html>
	...
	<body>
		...
		<div class="container">
			...
			<form method="post">
				<div class="form-group">
					...
					<input type="text" value="<?echo $ApplyJob;?>" name="subject" class="form-control" required />
				</div>
				
				<div class="form-group">
					<input type="email" name="receiver_email" value="<?echo $reciever;?>" class="form-control" required />
				</div>
				<div class="form-group">
					<label>SENDER EMAIL (YOUR EMAIL)</label>
					<input type="email" name="senderid" class="form-control" required />
				</div>
      ...
      Dear <?echo $recievername;?>
				...
				<div class="form-group">
					<input type="submit" name="send" class="btn btn-info" value="Send Email" /> <button style="cursor:pointer;padding:5px;border:0px;background-color: #f44336;color:#fff;" onclick="self.close()">Close this window</button>
				</div>
			</form>
			 <script>
