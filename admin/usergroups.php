                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTable1">
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = $result->fetch()) {
                                                ...
                                                // echo "<a href='includes/adminprocess.php?delete=" . $row['group_id'] . "&stop=" . $stop . "&form_submission=delete_group' title='Delete' class='btn btn-danger confirmation'><i class='fas fa-times'></i></a></div></td></tr>";
                                                echo "<a href='includes/adminprocess.php?delete=" . $row['group_id'] . "&stop=" . $stop . "&form_submission=delete_group&" . Csrf::queryParam() . "' title='Delete' class='btn btn-danger confirmation'><i class='fas fa-times'></i></a></div></td></tr>";
                                            }
                                            ?>
                                        </tbody>
                                    </table>
                            ...
                            <form action="includes/adminprocess.php" id="user-groups-create" class="form-horizontal" method="post">
                                ...
                                <div class="modal-body" id="modal-body">                                   
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" name="group_level" class="form-control" placeholder="Group Level "  />
                                            <!--data-toggle="tooltip" data-placement="bottom" title="A Group Level is another means of protecting content. For example, protect pages from those in groups lower than level 5."-->
                                        </div>
                                    </div>                                       
                                </div>
