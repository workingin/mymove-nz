...
<section id="main">
				  ...
				  <div class="panel-body">
					...
					<form method="post" id="postForm">							
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="jobtitle" name="jobtitle" value="<?php echo $userDetails['jobtitle']; ?>" placeholder="Job Title..">							
						</div>
	...
	<div class="form-group">
							<label for="lastname" class="control-label">Short Bio</label>							
							<textarea class="form-control" rows="5" id="bio" name="shortbio" placeholder="Short message.."><?php echo $userDetails['shortbio']; ?></textarea>					
						</div>	
						<div class="form-group">
