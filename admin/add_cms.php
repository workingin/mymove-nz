                                                    ...
                                                    <table class="table table-striped table-bordered table-hover" id="dataTable">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            while ($rowcat = $resultcat->fetch()) {
                                                                ...
                                                                echo "<tr><td><a href='editcms.php?editid=" . $row['id'] . "'>" . $row['title'] . "</a></td>"
                                                                . "<td>" . $catname . "</td>"
                                                                . "<td><a href='editcms.php?editid=" . $row['id'] . "'>Edit</a></td><td>-</td>"
                                                                . "<td class='text-center'><div class='btn-group btn-group-xs'><a href='adminuseredit.php?usertoedit=" . $row['title'] . "' title='Edit' class='open_modal btn btn-default'><i class='fas fa-edit'></i> View</a></td>"
                                                                . "</tr>";
                                                            }}
                                                            ?>
                                                        </tbody>
