                                                ...
                                                <div class="panel-body table-responsive">
                                                    <table class="table table-striped table-bordered table-hover" id="dataTable">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            {
                                                            $sql = "SELECT * FROM users WHERE username != '" . ADMIN_NAME . "' AND groupid='$groupid' ";
                                                            }
                                                            $result = $db->prepare($sql);
                                                            $result->execute();
                                                            while ($row = $result->fetch()) {
                                                            ...
                                                            while ($rowgroup = $resultgroup->fetch()) {
                                                                ...
                                                                . "<td class='text-center'><div class='btn-group btn-group-xs'><a href='adminuseredit.php?usertoedit=" . $row['username'] . "' title='Edit' class='open_modal btn btn-default'><i class='fas fa-edit'></i>User Full Activity</a></td>"
                                                                . "</tr>";
                                                            }}
                                                            ?>
                                                        </tbody>
