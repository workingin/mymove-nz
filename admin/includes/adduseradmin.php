...
function adminRegister($db, $session, $configs, $functions, $logger) {
    ...
    $retval = $registration->register($_POST['groupid'],$_POST['user'], $_POST['firstname'],isset($_POST['sportal']), isset($_POST['jportal']), isset($_POST['tportal']),isset($_POST['ctype']), $_POST['lastname'], $_POST['pass'], $_POST['conf_pass'], $_POST['email'], $_POST['conf_email'], 1);
